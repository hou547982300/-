            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                           ...
                           <dl>
                               <dt>仅限成都地区</dt>
                                <dd><img src="./image/sequare.png" alt=""> 填写基本资料</dd>
                                <dd><img src="./image/sequare.png" alt=""> 身份认证</dd>
                                <dd><img src="./image/sequare.png" alt=""> 视频认证</dd>
                           </dl>
                           <button type="button" class="btn btn-info">立即申请</button>    
                        </div>
            </div>
        </div>
        <div class="col-md-4">
